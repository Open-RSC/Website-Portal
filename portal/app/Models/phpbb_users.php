 ...
 * @property boolean $user_warnings
 * @property int $user_last_warning
 * @property boolean $user_login_attempts
 * @property boolean $user_inactive_reason
 ...
 * @property boolean $user_message_rules
 ...
 * @property boolean $user_notify
 * @property boolean $user_notify_pm
 * @property boolean $user_notify_type
 * @property boolean $user_allow_pm
 * @property boolean $user_allow_viewonline
 * @property boolean $user_allow_viewemail
 * @property boolean $user_allow_massemail
 ...
 * @property boolean $user_new
 * @property boolean $user_reminded
