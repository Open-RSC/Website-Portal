 ...
 * @property bool $forum_type
 * @property bool $forum_status
 ...
 * @property bool $forum_flags
 * @property bool $display_on_index
 * @property bool $enable_indexing
 * @property bool $enable_icons
 * @property bool $enable_prune
 * @property int $prune_next
 * @property int $prune_days
 * @property int $prune_viewed
 * @property int $prune_freq
 * @property bool $display_subforum_list
 * @property bool $display_subforum_limit
