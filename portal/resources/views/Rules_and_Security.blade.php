...
@section('content')
    <div class="text-gray-400 pr-5 pl-5 pt-3 pb-3 bg-black">
        ...
        <span class="d-block">6.4 Do not advertise OpenRSC to others as part of unsolicited DM/PMs, or in other servers where permission has not been granted. This is not helpful to us. It is a bad look for the project to advertise OpenRSC in spaces which are dedicated to other communities.</span>
