...
@section('content')
    <div class="text-gray-400 pr-5 pl-5 pt-3 pb-3 bg-black">
        ...
        <span class="d-block">6.4 Do not advertise OpenRSC to others as part of unsolicited DM/PMs, or in other servers where permission has not been granted. This is not helpful to us. It is a bad look for the project to advertise OpenRSC in spaces which are dedicated to other RS communities.</span>
        ...
        <span class="text-primary font-weight-bold d-block pt-4">8️⃣ There is a limit to how many accounts you can play simultaneously, but not a limit on how many you may register & play on in general. Exceeding this limit may result in a ban. The account limits are subject to change from time to time, you can always check the latest limit by typing ::mppi in-game</span>
        ...
        <span class="d-block">8.4 You are allowed to play 10 accounts simultaneously on RSC Uranium per IP address.</span>
        <span class="d-block">8.5 You are allowed to play 20 accounts simultaneously on RSC Coleslaw per IP address.</span>
