<table width="100%" cellpadding="0" cellspacing="0" style="background-color:#1c1c1c; color:#e0e0e0; font-family:Arial, sans-serif; padding:20px;">
    <tr>
        <td>
            ...
            <h2 style="color:#6be585;">OpenRSC ({{ \App\Helpers\uc_worlds($db) }}) Password Reset Successful</h2>
            ...
            <p style="margin-bottom:16px;">
                If you did not initiate this password reset, please contact us immediately by registering a forum account and posting on our forums:
