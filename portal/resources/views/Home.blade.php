            ...
            <td>
                <div style="LEFT: 0; TOP: 0; WIDTH: 600px; POSITION: relative;">
                    ...
                    <table>
                        <tbody>
                        <tr>
                            <td class="valign-top"><img src="{{ asset('img/edge_a.jpg') }}" height="43" width="100" alt=""></td>
                            <td valign="top"><img src="img/edge_c.jpg" height="42" width="400"></td>
                            <td valign="top"><img src="img/edge_d.jpg" height="43" width="100"></td>
                        </tr>
                        </tbody>
                    </table>
                    <table background="img/background2.jpg" height="570" width="600">
                        <tbody>
                        <tr>
                            <td valign="bottom">
                                <center>
