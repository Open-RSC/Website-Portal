    ...
    <div class="col container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-gray-400 pr-5 pl-5 pt-3 pb-3 bg-black">
                <a href="{{ route('ItemStatisticsList', $db) }}">Return to list</a>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '422']) }}" title="Pumpkin"
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '575']) }}" title="Christmas Cracker"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($cracker)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '576']) }}" title="Red Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($redphat)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '577']) }}" title="Yellow Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($yellowphat)
                        ...
                        <tr>
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '578']) }}" title="Blue Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($bluephat)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '579']) }}" title="Green Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($greenphat)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '580']) }}" title="Pink Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($pinkphat)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '581']) }}" title="White Partyhat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($whitephat)
                        ...
                        <tr>
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '677']) }}" title="Easter Egg"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($easteregg)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '831']) }}" title="Red Mask"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($redmask)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '832']) }}" title="Blue Mask"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($bluemask)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '828']) }}" title="Green Mask"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($greenmask)
                        ...
                        <tr>
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '971']) }}" title="Santa Hat"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($santahat)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '1289']) }}" title="Scythe"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($scythe)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '1278']) }}" title="Dragon Sq Shield"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($dsq)
                                        {{ number_format($dsq) }}
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '795']) }}" title="Dragon Med Helm"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($dmed)
                                        {{ number_format($dmed) }}
                        ...
                        <tr>
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '522']) }}" title="Dragonstone Amulet"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($dammy)
                                        {{ number_format($dammy) }}
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '594']) }}" title="Dragon Axe"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($dbattle)
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '593']) }}" title="Dragon Sword"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($dlong)
                                        {{ number_format($dlong) }}
                            ...
                            <td class="pl-1 pr-1 clickable-row" data-toggle="tooltip"
                                data-href="{{ route('ItemStatsItemList', ['db' => $db, 'itemID' => '81']) }}" title="Rune 2H Sword"
                                style="border: 1px solid black; background: rgba(255,255,255,0.2);">
                                <div style="margin-top: 0; position: relative; color: limegreen; font-size: 13px;">
                                    @if ($rune2h)
