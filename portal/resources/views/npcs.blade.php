...
@section('content')
    ...
    <script>
        ...
        function filterNPCs(searchTerm, page = 1) {
            fetch(`/npcSearch?searchTerm=${searchTerm}&page=${page}`)
                ...
                .then(data => {
                    ...
                    if (data.data && data.data.length > 0) {
                        ...
                        npcResults.innerHTML = '<p>No results found.</p>';
                    }
                });
        }
