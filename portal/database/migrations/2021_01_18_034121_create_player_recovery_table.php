...
class CreatePlayerRecoveryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('player_recovery', function (Blueprint $table) {
            ...
            $table->string('previous_pass', 512)->nullable();
            $table->string('earlier_pass', 512)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('player_recovery');
    }
}
