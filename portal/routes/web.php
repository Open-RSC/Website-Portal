...
Route::get('staff/error_logs', [StaffController::class, 'errorLogsList'])->name('ErrorLogsList');
Route::get('staff/error_logs/data', [StaffController::class, 'errorLogsData'])->name('ErrorLogsData');
Route::get('staff/error_logs/{id}', [StaffController::class, 'errorLogsView'])->name('ErrorLogsDetail');
