...
Route::get('playnow', [HomeController::class, 'playnow'])->name('Play OpenRSC '); // route name purposely left with a space to deconflict
Route::get('playnow/worldlist', [HomeController::class, 'worldlist'])->name('World List');
Route::get('play/{game}/{members}', [HomeController::class, 'play'])->name('Play OpenRSC');
...
Route::get('staff/admin_tasks', [StaffController::class, 'adminTasks'])->middleware('auth')->name('AdminTasks');
Route::get('staff/clear-cache', [StaffController::class, 'clearCache'])->middleware('auth')->name('ClearCache');
Route::get('staff/clear-views', [StaffController::class, 'clearViews'])->middleware('auth')->name('ClearViews');
Route::get('staff/clear-routes', [StaffController::class, 'clearRoutes'])->middleware('auth')->name('ClearRoutes');
Route::get('staff/clear-config', [StaffController::class, 'clearConfig'])->middleware('auth')->name('ClearConfig');
Route::get('staff/migrate-database', [StaffController::class, 'migrateDatabase'])->middleware('auth')->name('MigrateDatabase');
Route::get('staff/migrate-database-rollback', [StaffController::class, 'migrateDatabaseRollback'])->middleware('auth')->name('MigrateDatabaseRollback');
Route::get('staff/migrate-database-fresh', [StaffController::class, 'migrateDatabasFresh'])->middleware('auth')->name('MigrateDatabaseFresh');
Route::get('staff/migrate-database-refresh', [StaffController::class, 'migrateDatabasRefresh'])->middleware('auth')->name('MigrateDatabaseRefresh');
Route::get('staff/throttling', [StaffController::class, 'throttlingList'])->middleware('auth')->name('ThrottlingList');
Route::get('staff/throttling/create', [StaffController::class, 'createThrottling'])->middleware('auth')->name('ThrottlingCreate');
...
Route::get('/admin/webserver-info', 'AdminController@webserverInfo')->name('WebserverInfo');
